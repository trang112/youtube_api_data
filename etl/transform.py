...
def build_video_table(video_raw: list[dict], artist_name:str) -> pd.DataFrame:
    ...
    for page in video_raw: 
        ...
        for i in page["items"]:
            ...
            dict_video_info["view_count"] = i["statistics"]["viewCount"]
            dict_video_info["like_count"] = i["statistics"]["likeCount"]
            dict_video_info["comment_count"] = i["statistics"]["commentCount"]
...
def top_n_video(df:pd.DataFrame, top_n: int) -> list:
    ...
    top_n = df.nlargest(top_n,"view_count")["video_id"].tolist()
    return top_n
...
if __name__ == "__main__":
    ...
    top_10 = top_n_video(video_table, 10)
